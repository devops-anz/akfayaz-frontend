    ...
    >
      <div className='container-custom'>
        <div className='mb-10 sm:mb-16 md:mb-20 lg:mb-24 xl:mb-20'>
          <p
            className={`font-[700] ${poppins.className} pt-12 text-3xl sm:pt-16 sm:text-4xl md:pt-24 md:text-5xl lg:pt-28 lg:text-6xl xl:text-7xl`}
            style={{ color: featuredProjectsData?.title_color }}
          >
            {featuredProjectsData?.title}
          </p>
          <p className="mb-3 pt-6 text-sm sm:mb-4 sm:pt-8 sm:text-base md:mb-5 md:pt-10 md:text-lg lg:mb-6 lg:pt-12 lg:text-xl xl:mb-7 xl:pt-10 xl:text-2xl" style={{ color: featuredProjectsData?.subtitle_color }}>
          ...
          {featuredProjectsData?.featured_magazines.map((project: any, index: number) => (
            ...
            >
              ...
              <div className='w-full p-6 sm:p-8 md:p-10 lg:w-1/2 lg:p-12 xl:p-14'>
                {/* Date */}
                <div className="mb-3 text-sm sm:mb-4 md:mb-5 lg:mb-6 xl:mb-4" style={{ color: featuredProjectsData?.magazine_item_date_color }}>{project.date}</div>

                {/* Title */}
                <h3 className="mb-3 text-xl font-semibold sm:mb-4 sm:text-2xl md:text-3xl lg:mb-5 lg:text-xl xl:mb-6" style={{ color: featuredProjectsData?.magazine_item_title_color }}>
                ...
                <div
                  ...
                  style={{ color: featuredProjectsData?.magazine_item_description_color }}
                ...
                <div className='pt-5 sm:pt-6 md:pt-7 lg:pt-3 xl:pt-0'>
                  <a href={project.button_url} target='_blank' className="font-work relative flex items-center gap-1 bg-transparent px-0 py-1.5 text-base font-[500] ease-in after:absolute after:bottom-0 after:left-0 after:h-[2px] after:w-0 after:bg-black after:transition-all after:duration-500 hover:after:w-[70px]" style={{ color: featuredProjectsData?.magazine_item_button_text_color }} rel='noopener noreferrer'>
                    Read More
                  </a>
                </div>
              </div>
